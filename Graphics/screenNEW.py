...
def get_screenshots_of_reddit_posts_new(reddit_thread, screenshot_num: int, theme="dark"):
    ...
    with sync_playwright() as p:
        ...
        #page.screenshot(path=f'testing.png')
        #browser.close()
        ...
        print(page.locator('css=body').text_content)
        print("Page Title", page.title(), "\n")
        
        postTitlePath = f"./Assets/temp/{reddit_id}/png/title.png"
        page.locator(f"#post-title-t3_{reddit_id}").first.screenshot(path=postTitlePath)

        postContentPath = f"./Assets/temp/{reddit_id}/png/body.png"
        page.locator(f"#t3_{reddit_id}-post-rtjson-content").first.screenshot(path=postContentPath)
        #page.locator(f'[data-test-id="post-content"]').screenshot(path=f'./Assets/temp/{reddit_id}/png/test2.png')
        #posts = page.locator("data-testid=post-container")
        #posts.first.screenshot(path=postcontentpath)
